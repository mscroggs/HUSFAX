...
page2 = CountdownPage("121", "Lockdown 1", datetime(2020, 3, 23, 20, 30))
page3 = CountdownPage("122", "Lockdown 2", datetime(2020, 11, 5, 0, 1))
page4 = CountdownPage("123", "EMF2022", datetime(2022, 8, 21, 11, 0))
page5 = CountdownPage("124", "Pi Day", next(3, 14, 0, 0))
page6 = CountdownPage("125", "May Day", next(5, 1, 0, 0))
page7 = CountdownPage("126", "Ed Balls Day", next(4, 28, 0, 0))
page8 = CountdownPage("127", "Next year", next(1, 1, 0, 0))
page9 = CountdownPage("128", "US Election", datetime(2020, 11, 3, 0, 0))
page10 = CountdownPage("129", "UK left the EU", datetime(2020, 1, 31, 23, 0))
page11 = CountdownPage("130", "MathsJam", datetime(2020, 11, 21, 12, 0))
