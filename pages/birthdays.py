...
class BdayPage(Page):
    ...
    def background(self):
        ...
        more_birthdays = {"Kathleen Lonsdale": (1, 28, 1903),
            ...
            if day == s_day and mon == s_mon:
                if day in self.c_b[mon]:
                    ...
                    for p, person in enumerate(self.c_b[mon][day].split(", ")):
                        ...
                        self.add_title(person, bg="GREEN", fg="BLACK",
                                       font="size4", fill=False)
                        self.move_cursor(y=y, x=0)
                        ...
                        self.add_title(age, bg="GREEN", fg="BLACK",
                                       font="size4bold", fill=False,
                                       pre=80 - age_length)
                        y = y + 4
                ...
                self.add_text(" " + "%2i" % day + " ")
                self.add_text(self.months[mon])
                self.end_fg_color()
                self.end_bg_color()
